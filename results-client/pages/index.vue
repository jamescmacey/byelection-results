...
export default {
  head: {
    ...
    meta: [
      {name: "twitter:image", content: "https://storage.googleapis.com/wheretheystand-nz/nzpm_app/tga_results_card.png"},
      ...
      {name: "og:image", content: "https://storage.googleapis.com/wheretheystand-nz/nzpm_app/tga_results_card.png"},
  ...
  methods: {
    ...
    async getIsAlive () {
      if (!this.isAlive) {
        var data = await $fetch('https://storage.googleapis.com/wheretheystand-elections/legacy/tauranga-2022/is-alive.json')
    ...
    async getStatics () {
      ...
      var data = await $fetch('https://storage.googleapis.com/wheretheystand-elections/legacy/tauranga-2022/config-data.json')
      var data = JSON.parse(data);
    ...
    async getResults () {
      this.loadingIncrement = this.loadingIncrement + 1;
      var data = await $fetch('https://storage.googleapis.com/wheretheystand-elections/legacy/tauranga-2022/results.json')
      var data = JSON.parse(data);
